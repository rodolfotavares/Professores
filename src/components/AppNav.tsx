...
function Icon({ name }: { name: IconName }) {
  ...
  if (name === 'bot') return <svg {...common}><rect x="5" y="7" width="14" height="12" rx="3" /><path d="M12 7V3" /><path d="M8.5 12h.01" /><path d="M15.5 12h.01" /><path d="M9 16h6" /><path d="M4 13H2" /><path d="M22 13h-2" /></svg>;
